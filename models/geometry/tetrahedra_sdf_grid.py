...
from .geodream_geometry_volume import GeodreamGeometryVolume
from threestudio.utils.typing import *


@threestudio.register("tetrahedra-sdf-grid-geodream")
class TetrahedraSDFGridGeoDream(BaseExplicitGeometry):
    @dataclass
